  ...
  if (loading) {
    return (
      <div className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2">
        <div className="h-4 w-4 animate-spin rounded-full border-2 border-slate-300 border-t-[#10B981]"></div>
    ...
    return (
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          className="flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-[#1f2937] transition hover:border-[#10B981] hover:bg-slate-50"
        >
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      >
        ...
        <svg
          className={`h-3 w-3 flex-shrink-0 text-slate-400 transition-transform ${showDropdown ? "rotate-180" : ""}`}
          fill="none"
          stroke="currentColor"
          strokeWidth="2"
          viewBox="0 0 24 24"
      ...
      {showDropdown && (
        <div className="absolute left-0 right-0 lg:left-1/2 lg:right-auto top-full z-50 mt-2 w-full lg:w-80 lg:-translate-x-1/2 rounded-xl border border-slate-200 bg-white shadow-lg">
          ...
          <div className="p-2">
            <input
              ...
              className="w-full rounded-lg border border-[#10B981] px-3 py-2 text-sm text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#10B981]/20"
              autoFocus
            />
          </div>
          ...
          <div className="border-t border-slate-200 p-2">
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg bg-[#10B981] px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-[#10B981]/90"
            >
              <svg className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
              </svg>
