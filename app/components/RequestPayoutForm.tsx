  ...
  return (
    <form className="mt-6 space-y-6 text-sm" onSubmit={onSubmit}>
      ...
      <label className="block">
        ...
        <div className="relative mt-2 flex w-full items-center justify-center rounded-2xl border-2 border-dashed border-[#10B981]/40 bg-[#f8faff] p-6 text-center text-sm text-slate-500 transition hover:border-[#10B981] hover:bg-[#10B981]/5">
          <input
      ...
      <button
        ...
        className="w-full rounded-xl bg-[#10B981] px-4 py-3 text-sm font-semibold text-white shadow-[0_10px_20px_rgba(47,75,255,0.3)] transition hover:-translate-y-0.5 disabled:cursor-not-allowed disabled:opacity-60"
      >
