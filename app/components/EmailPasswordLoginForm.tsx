  ...
  return (
    <form className="space-y-6" onSubmit={usePassword ? loginWithPassword : (step === "enter" ? sendOtp : verifyOtp)}>
      <div className="space-y-3">
        ...
        <input
          className="w-full rounded-2xl border border-slate-200 bg-white px-3 py-3 text-sm font-medium text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#10B981]"
          id="email"
          type="email"
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="h-4 w-4 rounded border-slate-300 text-[#10B981] focus:ring-2 focus:ring-[#10B981]"
        />
      ...
      <button
        className="w-full rounded-2xl bg-[#10B981] px-5 py-3 text-sm font-semibold text-white shadow-[0_10px_25px_rgba(47,75,255,0.35)] transition hover:-translate-y-0.5 disabled:opacity-60"
        type="submit"
        disabled={loading}
      >
      ...
      {!usePassword && step === "verify" && (
        <div className="space-y-3 text-center text-sm font-semibold text-slate-600">
          ...
          <button
            ...
            className="inline-block rounded-xl border border-slate-200 px-4 py-2 text-[#10B981] hover:bg-slate-50 transition"
            disabled={loading}
          >
            Change Email
          </button>
