  ...
  return (
    <ProtectedRoute>
      <AppShell activePath="/add-new-book">
        <section className="mx-auto flex max-w-2xl flex-col gap-4 sm:gap-6 md:gap-8 px-4 sm:px-6 py-4 sm:py-6 md:py-10">
          <div className="rounded-[12px] sm:rounded-2xl md:rounded-[32px] border border-slate-200 bg-white p-4 sm:p-6 md:p-8 shadow-panel">
            <h1 className="mb-1.5 sm:mb-2 text-lg sm:text-xl md:text-2xl font-semibold text-[#1f2937]">Add New Book</h1>
            <p className="mb-4 sm:mb-6 md:mb-8 text-xs sm:text-sm text-slate-500">
              Create a new cashbook for tracking financial transactions
            </p>

            {error && (
              <div className="mb-4 sm:mb-6 rounded-lg sm:rounded-xl bg-rose-50 px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium text-rose-600">
                {error}
              </div>
            )}

            {success && (
              <div className="mb-4 sm:mb-6 rounded-lg sm:rounded-xl bg-emerald-50 px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium text-emerald-600">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5 md:space-y-6">
              <div className="space-y-1.5 sm:space-y-2">
                <label htmlFor="name" className="block text-xs sm:text-sm font-medium text-[#1f2937]">
                ...
                <input
                  ...
                  required
                  className="w-full rounded-lg sm:rounded-xl md:rounded-2xl border border-slate-200 bg-white px-3 sm:px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm font-medium text-[#1f2937] focus:border-[#10B981] focus:outline-none focus:ring-2 focus:ring-[#10B981]/20"
              ...
              <div className="space-y-1.5 sm:space-y-2">
                <label htmlFor="description" className="block text-xs sm:text-sm font-medium text-[#1f2937]">
                  Description
                </label>
                <textarea
                  id="description"
                  ...
                  onChange={handleChange}
                  rows={3}
                  className="w-full rounded-lg sm:rounded-xl md:rounded-2xl border border-slate-200 bg-white px-3 sm:px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm font-medium text-[#1f2937] focus:border-[#10B981] focus:outline-none focus:ring-2 focus:ring-[#10B981]/20 resize-none"
              ...
              <div className="grid gap-4 sm:gap-5 md:gap-6 md:grid-cols-2">
                <div className="space-y-1.5 sm:space-y-2">
                  <label htmlFor="currencyCode" className="block text-xs sm:text-sm font-medium text-[#1f2937]">
                    Currency <span className="text-rose-500">*</span>
                  </label>
                  {loadingCurrency ? (
                    <div className="w-full rounded-lg sm:rounded-xl md:rounded-2xl border border-slate-200 bg-slate-50 px-3 sm:px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm text-slate-500">
                      Loading currency...
                    </div>
                  ) : (
                    <select
                      ...
                      onChange={handleChange}
                      required
                      className="w-full rounded-lg sm:rounded-xl md:rounded-2xl border border-slate-200 bg-slate-50 px-3 sm:px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm font-medium text-[#1f2937] cursor-not-allowed"
                      disabled={true}
                    >
                ...
                <div className="space-y-1.5 sm:space-y-2">
                  <label htmlFor="ownerUserId" className="block text-xs sm:text-sm font-medium text-[#1f2937]">
                    Owner
                  </label>
                  <input
                    id="ownerUserId"
                    ...
                    disabled
                    className="w-full rounded-lg sm:rounded-xl md:rounded-2xl border border-slate-200 bg-slate-50 px-3 sm:px-4 py-2 sm:py-2.5 md:py-3 text-xs sm:text-sm font-medium text-slate-500 cursor-not-allowed"
                  />
                  <p className="text-[10px] sm:text-xs text-slate-500">
              ...
              <div className="space-y-3 sm:space-y-4 pt-3 sm:pt-4 border-t border-slate-200">
                <div className="space-y-1.5 sm:space-y-2">
                  <label className="block text-xs sm:text-sm font-medium text-[#1f2937]">
                    Add Staff Members
                  </label>
                  <p className="text-[10px] sm:text-xs text-slate-500">
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <div className="flex-1 flex gap-2">
                    <select
                      ...
                      className="rounded-lg sm:rounded-xl md:rounded-2xl border border-slate-200 bg-white px-2 sm:px-3 py-2 text-xs sm:text-sm font-medium text-[#1f2937] focus:border-[#10B981] focus:outline-none focus:ring-2 focus:ring-[#10B981]/20"
                      disabled={loading}
                    >
                    ...
                    {staffInputType === "email" ? (
                      <input
                        ...
                        className="flex-1 rounded-lg sm:rounded-xl md:rounded-2xl border border-slate-200 bg-white px-3 sm:px-4 py-2 text-xs sm:text-sm font-medium text-[#1f2937] focus:border-[#10B981] focus:outline-none focus:ring-2 focus:ring-[#10B981]/20"
                        disabled={loading}
                      />
                    ) : (
                      <input
                  ...
                  <button
                    ...
                    className="rounded-lg sm:rounded-xl md:rounded-2xl bg-[#10B981] px-3 sm:px-4 py-2 text-xs sm:text-sm font-semibold text-white transition hover:bg-[#10B981]/90 active:scale-95 disabled:opacity-60"
                ...
                {staffMembers.length > 0 && (
                  <div className="space-y-2">
                    <p className="text-[10px] sm:text-xs font-medium text-slate-600">Staff Members to Add:</p>
                    <div className="space-y-2">
                      {staffMembers.map((staff) => (
                        <div
                          key={staff.id}
                          className="flex items-center justify-between rounded-lg sm:rounded-xl border border-slate-200 bg-slate-50 px-3 sm:px-4 py-2"
                        >
                          <span className="text-xs sm:text-sm font-medium text-[#1f2937] truncate flex-1">
                            {staff.type === "email" ? staff.email : staff.phone}
                          </span>
                          <button
                            type="button"
                            onClick={() => handleRemoveStaffMember(staff.id)}
                            className="rounded-lg p-1 text-slate-400 hover:bg-slate-200 hover:text-rose-600 transition active:scale-95 flex-shrink-0 ml-2"
                            disabled={loading}
                          >
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-3 sm:pt-4">
                <button
                  ...
                  className="flex-1 rounded-lg sm:rounded-xl md:rounded-2xl border border-slate-200 bg-white px-4 sm:px-6 py-2.5 sm:py-3 text-xs sm:text-sm font-semibold text-[#1f2937] transition hover:bg-slate-50 active:scale-95 disabled:opacity-60"
                  disabled={loading}
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="flex-1 rounded-lg sm:rounded-xl md:rounded-2xl bg-[#10B981] px-4 sm:px-6 py-2.5 sm:py-3 text-xs sm:text-sm font-semibold text-white shadow-[0_4px_12px_rgba(16,185,129,0.3)] transition hover:shadow-[0_6px_16px_rgba(16,185,129,0.4)] active:scale-95 disabled:opacity-60"
