      ...
      <ProtectedRoute>
        <AppShell activePath="/cashbooks">
          <div className="flex min-h-screen items-center justify-center">
            <div className="h-8 w-8 animate-spin rounded-full border-4 border-slate-300 border-t-[#10B981]"></div>
          </div>
        </AppShell>
      </ProtectedRoute>
    );
          ...
          <div className="flex min-h-screen items-center justify-center">
            <div className="text-center">
              ...
              <button
                ...
                className="mt-4 rounded-lg bg-[#10B981] px-4 py-2 text-white"
              >
                Back to Cashbooks
              </button>
            </div>
              ...
              <div className="mb-4 grid grid-cols-2 gap-2 sm:gap-4 sm:grid-cols-3 lg:grid-cols-6">
                ...
                <div className="relative">
                  <button
                    ...
                    className="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-left text-sm text-slate-700 focus:border-[#10B981] focus:outline-none focus:ring-2 focus:ring-[#10B981]/20"
                  >
                    ...
                    <div className="absolute left-0 top-full z-50 mt-1 w-full rounded-lg border border-slate-200 bg-white shadow-lg">
                      ...
                      <div className="flex justify-end gap-2 border-t border-slate-200 p-2">
                        ...
                        <button
                          ...
                          className="rounded bg-[#10B981] px-3 py-1 text-sm text-white hover:bg-[#10B981]/90"
                        >
                          Done
                        </button>
                      </div>
                ...
                <div className="relative">
                  ...
                  {openDropdown === "parties-empty" && (
                    <div className="absolute left-0 top-full z-50 mt-1 w-64 rounded-lg border border-slate-200 bg-white p-4 shadow-lg">
                      ...
                      <button
                        onClick={() => setOpenDropdown(null)}
                        className="w-full rounded-lg bg-[#10B981] px-4 py-2 text-sm font-medium text-white hover:bg-[#10B981]/90"
                      >
                        Ok, Got it
                      </button>
                    </div>
                    ...
                    <div className="absolute left-0 top-full z-50 mt-1 w-full rounded-lg border border-slate-200 bg-white shadow-lg">
                      <div className="p-2">
                        <input
                          ...
                          className="mb-2 w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:border-[#10B981] focus:outline-none focus:ring-2 focus:ring-[#10B981]/20"
                        />
                    ...
                    <div className="absolute left-0 top-full z-50 mt-1 w-full rounded-lg border border-slate-200 bg-white shadow-lg">
                      <div className="p-2">
                        <input
                          ...
                          className="mb-2 w-full rounded-lg border border-[#10B981] px-3 py-2 text-sm focus:border-[#10B981] focus:outline-none focus:ring-2 focus:ring-[#10B981]/20"
                        />
                        {paymentModesList
                ...
                <div className="flex-1">
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-slate-200 bg-white px-4 py-2 pl-10 pr-4 text-sm text-slate-700 placeholder-slate-400 focus:border-[#10B981] focus:outline-none focus:ring-2 focus:ring-[#10B981]/20"
                    />
                    <svg
          ...
          <div className="w-full max-w-full px-2 py-8 sm:px-3 lg:px-4 overflow-x-hidden">
            {loadingEntries ? (
              <div className="flex min-h-[400px] items-center justify-center rounded-xl border border-slate-200 bg-white p-12">
                <div className="text-center">
                  <div className="mx-auto mb-4 h-8 w-8 animate-spin rounded-full border-4 border-slate-200 border-t-[#10B981]"></div>
                        ...
                        <div className="flex items-center gap-2">
                          <div className="relative">
                            <button
                              ...
                              className="relative inline-flex items-center rounded-md border border-slate-300 bg-white px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 focus:outline-none focus:ring-2 focus:ring-[#10B981] focus:ring-offset-2"
                            >
                              Page {currentPage}
              ...
              >
                  ...
                  <div className="space-y-4">
                      ...
                      <div className="relative">
                        ...
                        <div className="relative">
                          <input
                            ...
                            className="w-full cursor-pointer rounded-lg border border-slate-200 bg-white px-4 py-2.5 pr-10 text-sm text-slate-700 focus:border-[#10B981] focus:outline-none focus:ring-2 focus:ring-[#10B981]/20"
                          />
                          <svg
                                    ...
                                    <button
                                      ...
                                      className={`py-2 text-sm transition ${
                                        isSelected
                                          ...
                                          : isToday
                                          ? "rounded-full bg-slate-100 text-[#10B981] font-semibold"
                        ...
                        {showTimePicker && (
                          <div className="absolute left-0 top-full z-50 mt-2 w-64 rounded-lg border border-slate-200 bg-white p-4 shadow-lg">
                              ...
                              <div className="flex-1">
                                ...
                                <div className="relative">
                                  <button
                                    ...
                                    className={`w-full rounded-lg border bg-white px-4 py-2.5 pr-10 text-left text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#10B981]/20 ${
                                      showHourDropdown ? "border-[#10B981]" : "border-slate-200"
                                    }`}
                                  >
                              ...
                              <div className="flex-1">
                                ...
                                <div className="relative">
                                  <button
                                    ...
                                    className={`w-full rounded-lg border bg-white px-4 py-2.5 pr-10 text-left text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#10B981]/20 ${
                                      showMinuteDropdown ? "border-[#10B981]" : "border-slate-200"
                                    }`}
                                  >
                              ...
                              <div className="flex-1">
                                ...
                                <div className="relative">
                                  <button
                                    ...
                                    className={`w-full rounded-lg border bg-white px-4 py-2.5 pr-10 text-left text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#10B981]/20 ${
                                      showAmPmDropdown ? "border-[#10B981]" : "border-slate-200"
                                    }`}
                                  >
                            ...
                            <button
                              ...
                              className="mt-4 w-full rounded-lg bg-[#10B981] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#10B981]/90 transition"
                            >
                              Done
                            </button>
                          </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-700 placeholder-slate-400 focus:border-[#10B981] focus:outline-none focus:ring-2 focus:ring-[#10B981]/20"
                      />
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full rounded-lg border bg-white px-4 py-2.5 pr-10 text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#10B981]/20 ${
                            showPartyDropdown ? "border-[#10B981]" : "border-slate-200"
                          }`}
                        />
                        <svg
                          className="absolute right-3 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-400"
                          ...
                          <div className="absolute left-0 top-full z-50 mt-1 w-full rounded-lg border border-slate-200 bg-white shadow-lg">
                            <div className="max-h-64 overflow-y-auto p-2">
                              {loadingParties ? (
                                <div className="flex items-center justify-center py-4">
                                  <div className="h-5 w-5 animate-spin rounded-full border-2 border-slate-300 border-t-[#10B981]"></div>
                                </div>
                            ...
                            <div className="border-t border-slate-200 p-2 space-y-2">
                              <button
                                ...
                                className="flex w-full items-center gap-2 rounded-lg bg-[#10B981] px-4 py-2 text-sm font-medium text-white hover:bg-[#10B981]/90 transition"
                              >
                                <svg className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
                                </svg>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full rounded-lg border bg-white px-4 py-2.5 pr-10 text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#10B981]/20 ${
                            showCategoryDropdown ? "border-[#10B981]" : "border-slate-200"
                          }`}
                        />
                        <svg
                          className="absolute right-3 top-1/2 h-5 w-5 -translate-y-1/2 text-slate-400"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className={`w-full rounded-lg border bg-white px-4 py-2.5 pr-20 text-sm text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-[#10B981]/20 ${
                            showPaymentModeDropdown ? "border-[#10B981]" : "border-slate-200"
                          }`}
                        />
                    ...
                    <div>
                      ...
                      <label
                        htmlFor="file-upload"
                        className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-lg border-2 border-dashed border-slate-300 bg-slate-50 px-4 py-3 text-sm font-medium text-slate-700 transition hover:border-[#10B981] hover:bg-slate-100"
                      >
                        <svg className="h-5 w-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                    ...
                    <div className="flex items-center justify-between rounded-lg border border-slate-200 bg-slate-50 p-4">
                      ...
                      <button className="rounded-lg bg-[#10B981] px-4 py-2 text-sm font-medium text-white hover:bg-[#10B981]/90">
                        Configure
                      </button>
                    </div>
                  </div>
                ...
                <div className="sticky bottom-0 flex gap-3 border-t border-slate-200 bg-white px-6 py-4">
                  <button
                    ...
                    className="flex-1 rounded-lg bg-[#10B981] px-6 py-3 text-sm font-semibold text-white shadow-sm hover:bg-[#10B981]/90 transition disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <div className="w-full max-w-md rounded-2xl bg-white shadow-xl">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="flex gap-2">
                      <div className="relative w-24">
                        <select className="w-full appearance-none rounded-lg border border-slate-200 bg-white px-3 py-2.5 pr-8 text-sm text-slate-700 focus:border-[#10B981] focus:outline-none focus:ring-2 focus:ring-[#10B981]/20">
                      ...
                      <input
                        ...
                        className="flex-1 rounded-lg border border-slate-200 bg-white px-4 py-2.5 text-sm text-slate-700 placeholder-slate-400 focus:border-[#10B981] focus:outline-none focus:ring-2 focus:ring-[#10B981]/20"
                      />
                    </div>
                  </div>
                ...
                <div className="flex justify-end gap-3 border-t border-slate-200 px-6 py-4">
                  ...
                  <button
                    ...
                    className="rounded-lg bg-[#10B981] px-4 py-2 text-sm font-semibold text-white hover:bg-[#10B981]/90 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <div className="sticky bottom-0 bg-white border-t border-slate-200 px-6 py-4 flex gap-3">
                ...
                {userPermissions.includes("cashbooks.update") && (
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 rounded-lg bg-[#10B981] px-4 py-2.5 text-sm font-semibold text-white hover:bg-[#10B981]/90 transition"
                  >
                    <svg className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                ...
                {booksList.length > 0 ? (
                  <div>
                    ...
                    <select
                      ...
                      className="w-full rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm text-slate-700 focus:border-[#10B981] focus:outline-none focus:ring-2 focus:ring-[#10B981]/20"
                    >
              ...
              <div className="flex items-center justify-between border-t border-slate-200 px-6 py-4 bg-white">
                ...
                <div className="flex gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 rounded-lg bg-[#10B981] px-4 py-2 text-sm font-semibold text-white hover:bg-[#10B981]/90 transition disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <svg className="h-4 w-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
                    </svg>
            ...
            <div className="w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden">
                  ...
                  <div className="space-y-3">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        disabled
                        className="w-4 h-4 text-[#10B981] border-slate-300 rounded focus:ring-[#10B981]"
                      />
              ...
              <div className="flex items-center justify-end gap-3 border-t border-slate-200 px-6 py-4 bg-white">
                ...
                <button
                  ...
                  className="rounded-lg bg-[#10B981] px-4 py-2 text-sm font-semibold text-white hover:bg-[#10B981]/90 transition"
                >
                  Save PDF Settings
                </button>
              </div>
